...
<body class="flex flex-col min-h-screen">
    ...
    <div class="flex-grow flex flex-col bg-[lavender]">
        ...
        <div class="promo py-4">
            <div class="container mx-auto">
                <h2 class="text-center text-4xl font-bold text-[#B565A7] mb-6">Features our users love</h2>
            </div>
        </div>

        <div class="container h-44 px-4 mt-2 mb-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="h-44 bg-[#f0efef] p-4 flex flex-col justify-center items-center rounded-md shadow-md transform transition duration-500 hover:scale-105">
